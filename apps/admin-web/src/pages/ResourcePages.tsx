  ...
  const config: ResourceConfig = {
    ...
    createFields: [
      ...
      { name: 'provider_type', label: 'Provider type', required: true, type: 'select', options: [
        { value: 'openai', label: 'OpenAI' }, { value: 'openai_compatible', label: 'OpenAI-compatible / custom gateway' },
        { value: 'anthropic', label: 'Anthropic' }, { value: 'gemini', label: 'Google Gemini' },
      ...
      { name: 'base_url', label: 'Base URL', type: 'url', required: true, placeholder: 'https://api.openai.com/v1', hint: 'Use an authorized official endpoint or an allowlisted OpenAI-compatible gateway such as https://pro.muyuai.top/v1.' },
