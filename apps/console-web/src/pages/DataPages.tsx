...
import { Activity, ArrowUpRight, Box, Coins, Database, Download, Eye, Filter, Layers3, Search, Sparkles } from 'lucide-react'
import { addDecimalStrings, api, apiDownload, asPage, formatDate, formatMoney, formatNumber } from '../lib/api'
...
function normalizeUsage(value: unknown): UsageSummary {
  ...
  return {
    ...
    estimated_cost: addDecimalStrings(daily.map((row) => row.cost ?? '0')),
...
export function NotFoundPage() {
  return <div className="not-found"><span>404</span><h1>Page not found</h1><p>The requested Console page does not exist.</p><a href="/console"><Button variant="primary">Return to overview</Button></a></div>
}
