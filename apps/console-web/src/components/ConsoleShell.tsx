...
export function ConsoleShell() {
  ...
  return <div className={`app-frame console-frame ${collapsed ? 'sidebar-collapsed' : ''}`}>
    ...
    <aside className={`sidebar ${mobileOpen ? 'mobile-open' : ''}`}>
      <div className="sidebar-top"><div className="brand"><span className="brand-mark"><Network size={18} /></span><span><strong>RelayDock</strong><small>Cloud console</small></span></div><button className="mobile-close" onClick={() => setMobileOpen(false)} aria-label="Close"><X size={18} /></button></div>
      ...
      <div className="sidebar-bottom"><div className="console-user"><span className="avatar">U</span><span className="profile-copy"><strong>RelayDock user</strong><small>Console access</small></span><ChevronDown size={14} /></div></div>
    </aside>
